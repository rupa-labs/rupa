...
#[derive(Clone, Debug, PartialEq, Default)]
pub enum Cursor {
    #[default] Default, Pointer, Wait, Text, Move, Help, NotAllowed, Crosshair, 
    Grab, Grabbing, EResize, NResize, NEResize, NWResize, SResize, SEResize, SWResize, WResize,
}
...
pub struct Interactivity {
    ...
    pub cursor: Cursor,
    pub field_sizing: String, // "content" or "fixed"
