...
impl<'a> Overlay<'a> {
    ...
    /// Adds a child to the overlay. Internal boxing handled by Children.
...
/// A focused dialog box that blocks background interaction.
pub struct Modal<'a> {
    pub id: String,
    pub children: Children<'a>,
    pub style: Arc<RwLock<Style>>,
...
/// A small contextual hint appearing on hover or focus.
