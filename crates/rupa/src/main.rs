...
fn main() {
    ...
    App::new("Rupa")
        .title("Rupa | The Artisan's Playground")
        .version("1.0.0-alpha")
        .description("A semantic UI framework for the Rust ecosystem.")
        .author("Reasnov")
        .identifier("org.rupa.main")
            ...
            VStack::new()
                    ...
                    Section::new("Our Manifesto")
                        ...
                        .child(Box::new(
                            VStack::new()
                                .gap(24.0)
                                .child(Box::new(
                                    Text::new("Beyond pixels and shaders, Rupa is a testament to the harmony between logic and aesthetics.")
                ...
                .child(Box::new(
                    VStack::new()
                        ...
                        .child(Box::new(
                            Text::new("Thank you for choosing Rupa. Your commitment to high-fidelity engineering inspires us to push the boundaries of what a Rust UI framework can achieve.")
                                .style(text_color(Color::Semantic("text-muted".into(), None)))
                        ))
                ))
                // --- Framework Credits ---
