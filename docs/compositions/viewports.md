...
### 2. The Spacial View
- **Bridge:** Communicates with the **RenderCore** to set the global camera state before painting its children.
...
## 🔄 Interaction Flow
- **Viewport -> RenderCore:** Syncs camera matrices.
- **Viewport -> Input Dispatcher:** Captures multi-touch and scroll signals.
