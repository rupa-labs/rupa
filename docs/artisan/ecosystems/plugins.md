...
### 1. The Build Hook
Plugins implement the `Plugin` trait, which requires a `build()` method. This method is executed during the **Application Bootstrap**, granting the plugin mutable access to the `App` instance.
